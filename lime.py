...
def main():
    ...
    group.add_argument('-r', '--run', action='store_true', help='Compile the program then run it.')
    group.add_argument('-b', '--build', action='store_true', help='Build the program.')
    group.add_argument('-s', '--source', action='store_true', help='Generate compiled soruce code of the program.')
